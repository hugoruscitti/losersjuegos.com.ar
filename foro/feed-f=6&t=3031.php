...
<link rel="self" type="application/atom+xml" href="http://losersjuegos.com.ar/foro/feed.php?f=6&amp;t=3031" />
...
<id>http://losersjuegos.com.ar/foro/feed.php?f=6&amp;t=3031</id>
<entry>
...
<title type="html"><![CDATA[Re: pygame android eventos desde el teclado]]></title>
...
<entry>
<author><name><![CDATA[shackra]]></name></author>
<updated>2013-09-11T01:10:08+00:00</updated>
<id>http://losersjuegos.com.ar/foro/viewtopic.php?t=3031&amp;p=9279#p9279</id>
<link href="http://losersjuegos.com.ar/foro/viewtopic.php?t=3031&amp;p=9279#p9279"/>
<title type="html"><![CDATA[Re: pygame android eventos desde el teclado]]></title>

<content type="html" xml:base="http://losersjuegos.com.ar/foro/viewtopic.php?t=3031&amp;p=9279#p9279"><![CDATA[
Primero, bienvenido!<br /><br />Segundo, este tema esta en el subforo equivocado, pido que lo muevan.<br /><br />Tercero con respecto a éste trozo de código: <br /><br /><pre class="prettyprint">try:<br />    import android<br />except ImportError:<br />    android = None</pre><br /><br />¿De donde proviene el modulo <span style="font-style: italic">android</span> que usas dentro de Python?<p>Estadísticas: Publicado por <a href="http://losersjuegos.com.ar/foro/memberlist.php?mode=viewprofile&amp;u=2114">shackra</a> — Mié Sep 11, 2013 1:10 am</p><hr />
]]></content>
</entry>
<entry>
<author><name><![CDATA[dimoni73]]></name></author>
<updated>2013-09-06T14:01:57+00:00</updated>
<id>http://losersjuegos.com.ar/foro/viewtopic.php?t=3031&amp;p=9274#p9274</id>
<link href="http://losersjuegos.com.ar/foro/viewtopic.php?t=3031&amp;p=9274#p9274"/>
<title type="html"><![CDATA[pygame android eventos desde el teclado]]></title>

<content type="html" xml:base="http://losersjuegos.com.ar/foro/viewtopic.php?t=3031&amp;p=9274#p9274"><![CDATA[
Hola estimados amigos ante todo dar las gracias Hugo y el equipo de moderadores por haberme aceptado en el foro, hace tiempo que llevo siguiéndolo y me ha ayudado mucho, hoy en día estoy en un nivel medio en Python he probado otros lenguaje pero Python es el lenguaje más amigable,  legible y potente que muchos otros dicho esto la cuestión es que estoy programando algún jueguecillo en Pygame para ver como interactua con Android.<br /><br />He creado un pequeño juego de naves espaciales utilizando los eventos del mouse es decir &quot;pygame.mouse.MOUSEBUTTONDOWN&quot;  y demás eventos del mouse para el movimiento y disparo, los resultados más o menos son aceptables pero se me complica la cosa al principio del juego de prueba cuando quiero que el usuario ingrese su nick o nombre, creando una clase para imprimir el texto directamente  pantalla un amigo me dijo si me servía este código que encontró en la red ante todo perdonar si hay algunas tabulaciones mal son los editores tanto GEANY como GEDIT son una porqueria para python cuando te das cuenta esta todo el código mal pero mal y solo te marca errores de normal utilizo ECLIPSE pero hoy voy pegado de tiempo:<br /><br /><pre class="prettyprint">import pygame<br />from string import letters<br />from string import whitespace<br /><br />try:<br />    import android<br />except ImportError:<br />    android = None<br /> <br />pygame.init&#40;&#41;<br />size = width, height = 640, 480<br /> <br />#Colors<br />black = &#40;0, 0, 0&#41;<br />white = &#40;255, 255, 255&#41;<br />green = &#40;0, 255, 0&#41;<br />blue = &#40;0, 0, 255&#41;<br />red = &#40;255, 0, 0&#41;<br /><br />#Esta es la clase que os comentaba<br /><br />class Text:<br />    def __init__&#40;self, FontName = None, FontSize = 20&#41;:<br />        pygame.font.init&#40;&#41;<br />        self.font = pygame.font.Font&#40;FontName, FontSize&#41;<br />        self.size = FontSize<br /> <br />    def render&#40;self, surface, text, color, position&#41;:<br />        text = unicode&#40;text, &quot;UTF-8&quot;&#41;<br />        x, y = position<br />        for i in text.split&#40;&quot;\r&quot;&#41;:<br />            surface.blit&#40;self.font.render&#40;i, 1, color&#41;, &#40;x, y&#41;&#41;<br />            y += self.size<br /> <br /><br />def main&#40;&#41;:<br />    if android:<br />        android.init&#40;&#41;<br />        android.map_key&#40;android.KEYCODE_BACK, pygame.K_ESCAPE&#41;<br /><br /><br />    screen = pygame.display.set_mode&#40;size&#41;<br /><br />    text = Text&#40;&quot;FreeSansBold.ttf&quot;, 30&#41;<br />    s = &quot;&quot;<br />    pygame.key.set_repeat&#40;100&#41;<br /><br /><br />    while True:<br />      # Android-specific:<br />      if android:<br />          if android.check_pause&#40;&#41;:<br />             android.wait_for_resume&#40;&#41;<br /> <br /><br />      for event in pygame.event.get&#40;&#41;:<br />    if event.type == pygame.QUIT:<br />        exit&#40;&#41;<br />    if event.type == pygame.KEYDOWN:<br />                # Uno de mis intentos<br />if android:<br />    android.show_keyboard&#40;&#41;<br />            android.map_key&#40;android.KEYCODE_W, pygame.K_w&#41;<br />            android.map_key&#40;android.KEYCODE_A, pygame.K_a&#41;<br />          android.map_key&#40;android.KEYCODE_D, pygame.K_d&#41;<br /><br />        if event.unicode in letters or event.unicode in whitespace:<br />       s += str&#40;event.unicode&#41;<br />        if event.key == pygame.K_BACKSPACE and len&#40;s&#41; &gt; 0:<br />       s = s[:-1]<br />  <br />        elif event.type == pygame.KEYDOWN and event.key == pygame.K_ESCAPE or event.type == pygame.QUIT:<br />                break<br />       <br />    <br />    screen.fill&#40;white&#41;<br />text.render&#40;screen, s, black, &#40;0, 0&#41;&#41;<br />pygame.display.flip&#40;&#41;<br /><br /><br /># This isn&#39;t run on Android.<br />if __name__ == &quot;__main__&quot;:<br />    main&#40;&#41;</pre><br /><br />Trás repetidos intentos de convertir el teclado del PC en el Android lo único que he conseguido es que me aparezca y desaparezga el teclado en Android pero sin imprimirme las letras en el PC el código funciona de maravilla, por favor ayuda.<br /><br /><br />Un saludo amigos...<p>Estadísticas: Publicado por <a href="http://losersjuegos.com.ar/foro/memberlist.php?mode=viewprofile&amp;u=3136">dimoni73</a> — Vie Sep 06, 2013 2:01 pm</p><hr />
]]></content>
</entry>
</feed>